...
TEST_CASE("HP python reference values", "[eos][hp]") {
  ...
  SECTION("P-T-V dependent functions") {
    ...
    std::map<std::tuple<double, double, double>, double> ref_gamma = {
        {{P1, T1, x1}, 2.4657610677261276e-05},
        {{P1, T1, x2}, 2.4657610677261276e-05},
        {{P1, T2, x1}, 3.133433379492222e-05},
        {{P1, T2, x2}, 3.133433379492222e-05},
        {{P2, T1, x1}, 1.3442642661043429e-05},
        {{P2, T1, x2}, 1.3442642661043429e-05},
        {{P2, T2, x1}, 1.523583221962454e-05},
        {{P2, T2, x2}, 1.523583221962454e-05}
    };
